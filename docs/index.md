...
- **350+ leagues across 14 sports** - Football, basketball, hockey, baseball, soccer (~250 leagues via ESPN discovery), cricket, lacrosse, MMA, boxing, rugby, volleyball, Australian football, softball, and racing (F1, NASCAR, IndyCar, MotoGP). 133 pre-configured leagues plus dynamically discovered soccer leagues.
